...
import { Menu, X, LogIn, Search, ChevronDown, Book, Laptop, Video, LucideIcon } from 'lucide-react';
      ...
      <div className="container flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2">
          <div className="relative w-10 h-10 bg-brand-purple rounded-full flex items-center justify-center">
            <div className="absolute -top-1 -right-1 w-5 h-5 bg-brand-yellow rounded-full animate-pulse-soft"></div>
